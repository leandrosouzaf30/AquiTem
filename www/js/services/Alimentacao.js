angular.module('App').factory('Alimentacao', function(FURL, $firebaseArray){
...
var Alimentacao = {
  ...
  createList:function(data){
    ...
    var itemcreate = $firebaseArray(ref.child('Categoria/Alimentacao'));
  ...
  itemlist:function(){
    return $firebaseArray(ref.child('Categoria/Alimentacao'));
  },
